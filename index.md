...
{% if paper.type=="engineering" %} <h2 style="background-color: #F00FFFF;"> Engineering </h2> {% elsif paper.type=="clinical" %} <h2 style="background-color: #F00FF00;"> Clinical </h2> {% endif %} &ensp;
**{{paper.title}}** <br>
{{paper.authors}} <br>
